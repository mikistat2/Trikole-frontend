  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] text-[#f0ece4] font-['Barlow','sans-serif'] p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-[420px] bg-[#111] rounded-[22px] border border-white/10 shadow-[0_40px_100px_rgba(0,0,0,0.8)] relative z-10 px-[30px] pb-[26px] pt-[28px] animate-slide-up">
        ...
        <p className="text-[18px] font-extrabold tracking-[-0.02em] text-center mb-[18px]">Start your race today</p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col">
          <label className="block text-[12px] font-semibold text-[#f0ece4]/50 mb-[5px] tracking-[0.03em]">Username</label>
          <input
          ...
          <input
            ...
            className="block w-full bg-white/5 border border-white/10 rounded-[10px] py-[10px] px-[13px] text-[14px] text-[#f0ece4] mb-[18px] outline-none focus:border-[#e85d24]/50 placeholder-white/20 transition-colors"
        ...
        <p className="text-center text-[13px] text-[#f0ece4]/40 m-0">
          Already racing?{' '}
          <button onClick={() => navigate('/login')} className="bg-transparent border-none text-[#e85d24] text-[13px] font-bold cursor-pointer p-0 hover:underline">
            Log in
          </button>
        </p>
      </div>
